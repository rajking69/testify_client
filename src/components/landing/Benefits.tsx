      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-24 z-10">
        ...
        >
            ...
            <div className="space-y-3 pt-1">
              <div className="flex items-center justify-between p-3 rounded-2xl bg-[#F4F8FC] dark:bg-slate-800/90 border border-slate-200/80 dark:border-slate-700">
                <div>
                  ...
                  <p className="text-[11px] text-slate-500 dark:text-slate-400">Structured MCQ &bull; Timed &bull; Auto-Proctored</p>
                </div>
          ...
          <div className="lg:col-span-6 space-y-4">
            ...
            <p className="text-slate-600 dark:text-slate-300 text-sm leading-relaxed">
              Testify gives teachers powerful tools to craft objective assessments. Add multiple choice questions with mark allocations, pass mark criteria, time limits, and optional bulk CSV/JSON import.
            </p>
            <ul className="space-y-2.5 pt-1 text-xs sm:text-sm font-semibold text-slate-700 dark:text-slate-300">
              <motion.li whileHover={{ x: 3 }} className="flex items-center gap-2.5 transition-transform">
                ...
                <span>Fast question authoring with CSV &amp; JSON bulk question import</span>
              </motion.li>
              <motion.li whileHover={{ x: 3 }} className="flex items-center gap-2.5 transition-transform">
                <CheckCircle2 className="h-4 w-4 text-[#00A3C4] dark:text-cyan-400 shrink-0" />
                <span>Teacher-controlled live webcam proctoring toggle during exam setup</span>
              </motion.li>
              <motion.li whileHover={{ x: 3 }} className="flex items-center gap-2.5 transition-transform">
                <CheckCircle2 className="h-4 w-4 text-[#00A3C4] dark:text-cyan-400 shrink-0" />
                <span>Instant automated score calculation and student submission tracking</span>
              </motion.li>
            </ul>
            <div className="pt-2">
              <Link
                href="/teacher/exams"
                className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full text-xs font-bold bg-[#00A3C4] hover:bg-[#008da9] text-white transition-all shadow-sm hover:shadow-md cursor-pointer"
              >
                <span>Open Teacher Exam Studio</span>
        ...
        >
          <div className="order-2 lg:order-1 lg:col-span-6 space-y-4">
            ...
            <h3 className="text-2xl sm:text-3xl font-extrabold font-display text-[#0B2238] dark:text-white">
              Distraction-free exam room with real-time feedback and auto-saving
            </h3>
            <p className="text-slate-600 dark:text-slate-300 text-sm leading-relaxed">
              Students take exams on a clean, responsive interface on laptops, tablets, or desktops. Answers are auto-saved in real time, preventing data loss on accidental disconnects.
            </p>
            <ul className="space-y-2.5 pt-1 text-xs sm:text-sm font-semibold text-slate-700 dark:text-slate-300">
              <motion.li whileHover={{ x: 3 }} className="flex items-center gap-2.5 transition-transform">
                <CheckCircle2 className="h-4 w-4 text-[#00A3C4] dark:text-cyan-400 shrink-0" />
                <span>Continuous auto-saving and server syncing for uninterrupted test taking</span>
              </motion.li>
              <motion.li whileHover={{ x: 3 }} className="flex items-center gap-2.5 transition-transform">
                <CheckCircle2 className="h-4 w-4 text-[#00A3C4] dark:text-cyan-400 shrink-0" />
                <span>Strict exam room security with 1-strike tab lockdown auto-submit</span>
              </motion.li>
              <motion.li whileHover={{ x: 3 }} className="flex items-center gap-2.5 transition-transform">
                <CheckCircle2 className="h-4 w-4 text-[#00A3C4] dark:text-cyan-400 shrink-0" />
                <span>Instant automated scorecards and pass/fail evaluation upon submission</span>
              </motion.li>
            </ul>
            <div className="pt-2">
              <Link
                href="/public-exams"
                className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full text-xs font-bold bg-[#E8922C] hover:bg-[#d6801b] text-white transition-all shadow-sm hover:shadow-md cursor-pointer"
              >
